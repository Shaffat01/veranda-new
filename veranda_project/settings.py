...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://neondb_owner:npg_9ifjbrI3XCkh@ep-damp-wind-ahura7yy-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require',
        conn_max_age=600,
        ssl_require=True
    )
}
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # Vercel এর জন্য এটি প্রয়োজন
